...
export const CoverLetterPage = () => (
  <>
    <Seo
      title="Cover Letter Builder | Write a Standout Cover Letter | Red Resumes"
      description="Generate high-quality cover letters tailored to your target job using our smart builder and professional layouts."
    />
    <Section h1 title="Cover letter builder" kicker="Cover letters">
      <div className="grid lg:grid-cols-[1fr_1fr] gap-8">
        <div className="border border-zinc-100 rounded-2xl p-6 bg-white">
          <h2 className="font-semibold text-zinc-900 text-base">Select resume</h2>
          <div className="mt-4 border border-zinc-200 rounded-lg px-3 py-2 text-sm text-zinc-500">VP Marketing Resume</div>
          <h2 className="font-semibold text-zinc-900 text-base mt-6">Template</h2>
          ...
          <h2 className="font-semibold text-zinc-900 text-base mt-6">Editor</h2>
        ...
        <div className="border border-zinc-100 rounded-2xl p-6 bg-white">
          <h2 className="font-semibold text-zinc-900 text-base">Preview</h2>
