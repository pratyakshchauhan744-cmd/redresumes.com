...
const fallbackCatalog = [
  ...
  {
    id: "demo-sde2-backend-razorpay",
    title: "Software Development Engineer II (Backend)",
    description: "Build robust, high-throughput payment systems, manage financial ledger microservices, and design highly available databases using Go and MySQL.",
    city: "Bengaluru",
    state: "Karnataka",
    country: "India",
    ...
    salaryMax: 3000000,
    currency: "INR",
    applyUrl: "https://razorpay.com/careers/#who-we-are",
    originalJobUrl: "https://razorpay.com/careers/#who-we-are",
    source: "demo",
    postedAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(),
    company: { id: "demo-company-razorpay", name: "Razorpay", website: "https://razorpay.com" },
  },
  {
    id: "demo-frontend-engineer-razorpay",
    title: "Frontend Engineer",
    description: "Design and implement beautiful, accessible, and high-performance payment checkouts and dashboards using React, TypeScript, and Tailwind CSS.",
    city: "Bengaluru",
    state: "Karnataka",
    country: "India",
